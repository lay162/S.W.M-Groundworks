        ...
        <div className="max-w-7xl mx-auto px-4 w-full">
          <div className="grid md:grid-cols-12 gap-16 md:gap-24 mb-16 text-center md:text-left">
            <div className="md:col-span-6 flex flex-col items-center md:items-start">
              <div className="mb-8 flex w-full flex-col items-center gap-5 text-center sm:gap-6 md:items-start md:self-start md:text-left">
                <div className="flex w-full max-w-[20rem] min-h-[9.5rem] items-center justify-center rounded-2xl bg-white px-6 py-5 shadow-lg sm:max-w-[22rem] sm:min-h-[10.5rem] sm:px-8 sm:py-6 md:w-auto md:max-w-none md:min-h-0 md:shrink-0 md:justify-start md:rounded-xl md:px-7 md:py-6">
                  <img
                    src="/S.W.M.logo.svg"
                    alt="S.W.M Groundworks"
              ...
              <p className="max-w-md text-center text-lg font-bold leading-relaxed tracking-tight text-zinc-500 mb-10 md:text-left">
